...
class TestConsoleChannel:
    ...
    async def test_console_channel_send(self, mock_prompt_session, mock_console_class):
        ...
        # 测试发送普通消息
        message = ChatMessage(content="Hello, world!", role="bot", channel_id="console")
    ...
    @patch("openbot.channels.console.Console")
    @patch("openbot.channels.console.PromptSession")
    async def test_console_channel_on_receive(
        self, mock_prompt_session, mock_console_class
    ):
        """测试控制台通道接收消息"""
        # 模拟依赖
        mock_console = Mock()
        ...
        # 测试接收消息
        message = ChatMessage(content="Hello", role="user", channel_id="console")
    ...
    @patch("openbot.channels.console.Console")
    @patch("openbot.channels.console.PromptSession")
    async def test_console_channel_show_status(
        self, mock_prompt_session, mock_console_class
    ):
        """测试显示状态信息"""
        # 模拟依赖
    ...
    @patch("openbot.channels.console.Console")
    @patch("openbot.channels.console.PromptSession")
    async def test_console_channel_show_tasks(
        self, mock_prompt_session, mock_console_class
    ):
        """测试显示任务信息"""
        # 模拟依赖
    ...
    @patch("openbot.channels.console.Console")
    @patch("openbot.channels.console.PromptSession")
    async def test_console_channel_show_channels(
        self, mock_prompt_session, mock_console_class
    ):
        """测试显示通道信息"""
        # 模拟依赖
    ...
    @patch("openbot.channels.console.Console")
    @patch("openbot.channels.console.PromptSession")
    def test_console_channel_show_version(
        self, mock_prompt_session, mock_console_class
    ):
        """测试显示版本信息"""
        # 模拟依赖
    ...
    @patch("openbot.channels.console.Console")
    @patch("openbot.channels.console.PromptSession")
    def test_console_channel_show_history(
        self, mock_prompt_session, mock_console_class
    ):
        """测试显示历史信息"""
        # 模拟依赖
    ...
    @patch("openbot.channels.console.Console")
    @patch("openbot.channels.console.PromptSession")
    async def test_console_channel_handle_command(
        self, mock_prompt_session, mock_console_class
    ):
        """测试处理命令"""
        # 模拟依赖
